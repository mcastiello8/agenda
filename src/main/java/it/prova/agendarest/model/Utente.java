...
public class Utente {
	...
	@OneToMany
	@JoinTable(name= "utente_agenda", joinColumns = @JoinColumn(name = "utente_id", referencedColumnName = "ID"), inverseJoinColumns = @JoinColumn(name = "agenda_id", referencedColumnName = "ID"))
